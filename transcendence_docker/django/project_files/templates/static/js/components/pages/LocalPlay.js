        ...
        <div class="container vh-100 d-flex align-items-center justify-content-center">
            <div class="row w-100">
                <div class="col-md-4 text-center d-flex flex-column align-items-center">
                    <img src="/static/media/assets/pongsplash.png" alt="Pong Game" class="img-fluid mt-2" style="width: 600px; height: auto;">
                    <div class="card bg-dark text-white mt-3" style="width: 18rem; border: 1px solid #343a40; opacity: 0.8;">
                        <div class="card-body">
                ...
                <div class="col-md-4 d-flex flex-column align-items-center">
                    <div class="card mb-3 bg-dark text-white w-100" style="border: 1px solid #343a40; opacity: 0.8;">
                        <div class="card-body">
                ...
                <div class="col-md-4 text-center d-flex flex-column align-items-center">
                    <img src="/static/media/assets/asteroidssplash.png" alt="Asteroids Game" class="img-fluid mt-2" style="width: 600px; height: auto;">
                    <div class="card bg-dark text-white mt-3" style="width: 18rem; border: 1px solid #343a40; opacity: 0.8;">
                        <div class="card-body">
                            <h5 class="card-title text-center">How To Play</h5>
                            <p class="card-text">
